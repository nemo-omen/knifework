...
// .svelte-kit/output/server/chunks/prisma.service-bc3a6dff.js
import { PrismaClient } from "@prisma/client";
var prisma;
var init_prisma_service_bc3a6dff = __esm({
  ".svelte-kit/output/server/chunks/prisma.service-bc3a6dff.js"() {
    init_shims();
...
// .svelte-kit/output/server/chunks/index.json-e5c5f085.js
var index_json_e5c5f085_exports = {};
__export(index_json_e5c5f085_exports, {
  get: () => get
});
import "@prisma/client";
var get;
var init_index_json_e5c5f085 = __esm({
  ".svelte-kit/output/server/chunks/index.json-e5c5f085.js"() {
    init_shims();
    init_prisma_service_bc3a6dff();
    get = async (params) => {
...
// .svelte-kit/output/server/chunks/index.json-2c80a195.js
var index_json_2c80a195_exports = {};
__export(index_json_2c80a195_exports, {
  get: () => get2
});
import "@prisma/client";
var get2;
var init_index_json_2c80a195 = __esm({
  ".svelte-kit/output/server/chunks/index.json-2c80a195.js"() {
    init_shims();
    init_prisma_service_bc3a6dff();
    get2 = async ({ params }) => {
...
// .svelte-kit/output/server/chunks/Icon-6ffa804a.js
import { createMachine, assign, interpret } from "xstate";
var menuMachine, menuService, paths, css, Icon;
var init_Icon_6ffa804a = __esm({
  ".svelte-kit/output/server/chunks/Icon-6ffa804a.js"() {
    init_shims();
    init_app_0cadbb1d();
    menuMachine = createMachine({
      id: "menu",
      initial: "collapsed",
      context: {
        currentMenu: null
      ...
      states: {
        collapsed: {
          on: {
            CLICK: {
              actions: assign({
                currentMenu: (context, event) => context.currentMenu = event == null ? void 0 : event.key
              }),
              target: "expanded"
            },
            GO: {
      ...
      guards: {
        isCurrent: (context, event) => context.currentMenu === (event == null ? void 0 : event.key),
        isNotCurrent: (context, event) => context.currentMenu !== (event == null ? void 0 : event.key)
      }
    });
    menuService = interpret(menuMachine).start();
    paths = {
      add: [
      ...
      add2: ["M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"],
      book: [
        "M20.005 2C21.107 2 22 2.898 22 3.99v16.02c0 1.099-.893 1.99-1.995 1.99H4v-4H2v-2h2v-3H2v-2h2V8H2V6h2V2h16.005zM8 4H6v16h2V4zm12 0H10v16h10V4z"
      ],
      bookmark: [
        "M5 2h14a1 1 0 0 1 1 1v19.143a.5.5 0 0 1-.766.424L12 18.03l-7.234 4.536A.5.5 0 0 1 4 22.143V3a1 1 0 0 1 1-1zm13 2H6v15.432l6-3.761 6 3.761V4z"
      ],
      bookmarkfill: [
        "M5 2h14a1 1 0 0 1 1 1v19.143a.5.5 0 0 1-.766.424L12 18.03l-7.234 4.536A.5.5 0 0 1 4 22.143V3a1 1 0 0 1 1-1z"
      ],
      cart: [
        "M4 16V4H2V2h3a1 1 0 0 1 1 1v12h12.438l2-8H8V5h13.72a1 1 0 0 1 .97 1.243l-2.5 10a1 1 0 0 1-.97.757H5a1 1 0 0 1-1-1zm2 7a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm12 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"
      ],
      close: [
      ...
      grid: [
        "M14 10v4h-4v-4h4zm2 0h5v4h-5v-4zm-2 11h-4v-5h4v5zm2 0v-5h5v4a1 1 0 0 1-1 1h-4zM14 3v5h-4V3h4zm2 0h4a1 1 0 0 1 1 1v4h-5V3zm-8 7v4H3v-4h5zm0 11H4a1 1 0 0 1-1-1v-4h5v5zM8 3v5H3V4a1 1 0 0 1 1-1h4z"
      ],
      home: [
        "M13 19h6V9.978l-7-5.444-7 5.444V19h6v-6h2v6zm8 1a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9.49a1 1 0 0 1 .386-.79l8-6.222a1 1 0 0 1 1.228 0l8 6.222a1 1 0 0 1 .386.79V20z"
      ],
      image: [
      ...
      save: [
        "M5 5v14h14V7.828L16.172 5H5zM4 3h13l3.707 3.707a1 1 0 0 1 .293.707V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm8 15a3 3 0 1 1 0-6 3 3 0 0 1 0 6zM6 6h9v4H6V6z"
      ],
      save2: [
        "M4 3h14l2.707 2.707a1 1 0 0 1 .293.707V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm3 1v5h9V4H7zm-1 8v7h12v-7H6zm7-7h2v3h-2V5z"
      ],
      settings: [
    ...
    css = {
      code: ".c.svelte-15halfw{width:1em;height:1em;fill:currentColor;overflow:visible}",
      map: null
    };
    Icon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css);
      paths$1 = paths[name] || [];
      return `<svg class="${"c svelte-15halfw"}" viewBox="${"0 0 24 24"}" fill-rule="${"evenodd"}" clip-rule="${"evenodd"}">${each(paths$1, (path) => `<path${add_attribute("d", path, 0)}></path>`)}</svg>`;
    });
  }
});

// .svelte-kit/output/server/chunks/__layout-ac9d5997.js
var layout_ac9d5997_exports = {};
__export(layout_ac9d5997_exports, {
  default: () => _layout
});
import "xstate";
var Sidebar, _layout;
var init_layout_ac9d5997 = __esm({
  ".svelte-kit/output/server/chunks/__layout-ac9d5997.js"() {
    init_shims();
    init_app_0cadbb1d();
    init_Icon_6ffa804a();
...
// .svelte-kit/output/server/chunks/error-3ce8ce0c.js
var error_3ce8ce0c_exports = {};
__export(error_3ce8ce0c_exports, {
  default: () => Error2,
  load: () => load
});
...
// .svelte-kit/output/server/chunks/index-737097d3.js
var index_737097d3_exports = {};
__export(index_737097d3_exports, {
  default: () => Routes,
  load: () => load2
});
import "xstate";
...
async function load2({ fetch: fetch2 }) {
  const res = await fetch2("/recipes.json");
  if (res.ok) {
...
var subscriber_queue, recipeStore, layout, RecipeGridLayout, Recipes, Shopping, css$1, Welcome, css2, PostRecipe, Routes;
var init_index_737097d3 = __esm({
  ".svelte-kit/output/server/chunks/index-737097d3.js"() {
    init_shims();
    init_app_0cadbb1d();
    init_Icon_6ffa804a();
    subscriber_queue = [];
    recipeStore = writable({});
    layout = writable("grid");
    RecipeGridLayout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    Shopping = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
`;
    ...
    PostRecipe = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let servings;
      let cooktime;
      let preptime;
      let name;
...
// .svelte-kit/output/server/chunks/app-0cadbb1d.js
...
function set_paths(paths3) {
  base = paths3.base;
  assets = paths3.assets || base;
}
...
${``}`;
    ...
    manifest = {
      ...
      routes: [
        ...
        },
        {
          ...
          params: empty,
          load: () => Promise.resolve().then(() => (init_index_json_e5c5f085(), index_json_e5c5f085_exports))
        },
        {
          type: "endpoint",
          pattern: /^\/recipes\/([^/]+?)\.json$/,
          params: (m) => ({ id: d(m[1]) }),
          load: () => Promise.resolve().then(() => (init_index_json_2c80a195(), index_json_2c80a195_exports))
        }
      ]
    };
    get_hooks = (hooks) => ({
    ...
    module_lookup = {
      "src/routes/__layout.svelte": () => Promise.resolve().then(() => (init_layout_ac9d5997(), layout_ac9d5997_exports)),
      ".svelte-kit/build/components/error.svelte": () => Promise.resolve().then(() => (init_error_3ce8ce0c(), error_3ce8ce0c_exports)),
      "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_737097d3(), index_737097d3_exports))
    };
    metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-30ec24a4.js", "css": ["assets/Icon-6d1ec59a.css"], "js": ["pages/__layout.svelte-30ec24a4.js", "chunks/vendor-33a2ae70.js", "chunks/Icon-61042554.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-37c24c87.js", "css": [], "js": ["error.svelte-37c24c87.js", "chunks/vendor-33a2ae70.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-f1b2913d.js", "css": ["assets/pages/index.svelte-81cc1d8e.css", "assets/Icon-6d1ec59a.css"], "js": ["pages/index.svelte-f1b2913d.js", "chunks/vendor-33a2ae70.js", "chunks/Icon-61042554.js"], "styles": [] } };
  }
});
...
var prerenderedMiddleware = fs__default.existsSync(paths2.prerendered) ? sirv(paths2.prerendered, {
  etag: true,
  maxAge: 0,
  gzip: true,
  brotli: true
}) : noop_handler;
var assetsMiddleware = fs__default.existsSync(paths2.assets) ? sirv(paths2.assets, {
