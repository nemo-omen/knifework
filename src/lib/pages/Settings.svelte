...
<section class="page">
  ...
  <div class="center">
    <div
      class="block-select {mode === 'easy' ? 'selected' : 'deselected'}"
      on:click={() => select('easy')}
    >
      <h2>Easy</h2>
    ...
    <div
      class="block-select {mode === 'advanced' ? 'selected' : 'deselected'}"
      on:click={() => select('advanced')}
    >
      <h2>Advanced</h2>
